...
import xyz.daijoubuteam.foodshoppingapp.client.home.search.SearchEateryProductAdapter
import xyz.daijoubuteam.foodshoppingapp.databinding.ItemSavedEateryBinding
...
class SavedEateriesAdapter(private val onClickListener: SavedEateriesAdapter.OnClickListener, private val savedViewModel: SavedViewModel): ListAdapter<Eatery, SavedEateriesAdapter.SavedEateryViewHolder>(DiffCallBack) {

    class SavedEateryViewHolder(private var binding: ItemSavedEateryBinding, private val savedViewModel: SavedViewModel): RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(eatery: Eatery) {
            ...
            binding.buttonFavorited.setOnClickListener {
                savedViewModel.unfavorite(eatery)
            }
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): SavedEateryViewHolder {
        val binding =  ItemSavedEateryBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return SavedEateryViewHolder(binding, savedViewModel)
    }

    override fun onBindViewHolder(holder: SavedEateryViewHolder, position: Int) {
